        ...
        >
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 text-center">
                ...
                <h1 className="hero-title text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                    Votre entreprise a-t-elle vraiment
                    <br />
                    <span className="text-secondary">besoin d'un Directeur Financier ?</span>
                </h1>

                {/* Subtitle */}
                <p className="hero-subtitle text-lg md:text-xl text-white/70 max-w-3xl mx-auto mb-12 leading-relaxed">
                    Guide pratique pour les dirigeants de PME qui veulent structurer leur
                    pilotage financier sans alourdir leur masse salariale.
                </p>
