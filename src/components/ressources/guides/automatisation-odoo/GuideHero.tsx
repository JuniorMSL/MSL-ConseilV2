...
// Odoo purple color palette
const ODOO_PURPLE = "#714b67";
const ODOO_PURPLE_DARK = "#4a2c40";
const ODOO_PURPLE_LIGHT = "#8e6180";
...
export default function GuideHero() {
    ...
    return (
        <section
            ...
            style={{
                background: `linear-gradient(135deg, ${ODOO_PURPLE_DARK} 0%, ${ODOO_PURPLE} 50%, ${ODOO_PURPLE_LIGHT} 100%)`
            }}
        >
            {/* Decorative elements */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 left-10 w-72 h-72 bg-secondary/10 rounded-full blur-[100px]" />
                <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-300/10 rounded-full blur-[120px]" />
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 text-center">
                ...
                <p className="hero-subtitle text-lg md:text-xl text-white/70 max-w-3xl mx-auto mb-12 leading-relaxed">
                    Passez à la vitesse supérieure : automatisez vos flux comptables, mettez en place
                    des indicateurs de pilotage et préparez la croissance de votre entreprise.
                </p>
